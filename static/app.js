(function(){
 ...
 const saved=localStorage.getItem('hikma-theme'); if(saved) root.dataset.theme=saved;
 window.toggleTheme=function(){const next=root.dataset.theme==='dark'?'light':'dark';root.dataset.theme=next;localStorage.setItem('hikma-theme',next)};
