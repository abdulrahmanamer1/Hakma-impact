...
- Direct image uploads for news, members and administrators
- Multi-image galleries for news and initiatives
- Responsive galleries
- Local media uploads under static/uploads

Note: Render's default filesystem is ephemeral. For production persistence of uploaded media and SQLite, use a persistent disk or external object storage.
